...
+        } else{
    ...
    \begin{figure}
        ...
        \includegraphics[scale=1.5]{../p/cactus-time.png}
    \end{figure}
    \begin{figure}
        \centering
        \caption{Overhead of reason deletions\label{fig:correlation-reason-deletions-time-delta}}
        \includegraphics[scale=1.5]{../p/correlation-reason-deletions-time-delta.png}
    \end{figure}
    \end{column}
  \end{columns}
\end{frame}
